...
import { Moon, Sun, Server, Shield } from "lucide-react";
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background relative overflow-hidden font-sans">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
        ...
        <div className="absolute -top-[10%] -right-[10%] w-[40%] h-[40%] bg-foreground/5 rounded-full blur-[120px] animate-pulse" />
        <div className="absolute -bottom-[10%] -left-[10%] w-[40%] h-[40%] bg-foreground/5 rounded-full blur-[120px] animate-pulse" style={{ animationDelay: '2s' }} />
      ...
      <div className="w-full flex flex-col items-center justify-center px-4 z-10">
        <div className="mb-16 text-center animate-in fade-in slide-in-from-bottom-6 duration-1000">
           <div className="w-24 h-24 bg-foreground/5 rounded-[2.5rem] flex items-center justify-center border border-foreground/10 mx-auto mb-10 shadow-3xl">
              <Server className="w-12 h-12 text-foreground" />
           </div>
           <h1 className="text-5xl font-black tracking-[-0.05em] mb-3 uppercase leading-none">WATCHTOWER</h1>
        ...
        <div className="relative w-full max-w-md animate-in fade-in zoom-in-95 duration-1000 delay-200">
          ...
          <Card className="border border-foreground/5 bg-card/40 backdrop-blur-3xl overflow-hidden rounded-[3rem] shadow-3xl">
              ...
              <SignIn 
                appearance={{
                  elements: {
                    ...
                    formFieldLabel: "text-foreground font-black text-[10px] uppercase tracking-[0.2em] mb-3 opacity-40 ml-1",
                  }
                }}
              />
            </CardContent>
        ...
        {/* Footer */}
        <div className="text-center mt-20 space-y-6 animate-in fade-in duration-1000 delay-500">
          ...
          <p className="text-[10px] font-black text-muted-foreground/30 tracking-[0.5em] uppercase italic">
            v4.2.0-STABLE | SECURE_DYN_01
          </p>
        </div>
      </div>
    </div>
